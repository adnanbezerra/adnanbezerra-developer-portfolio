...
export const translations = {
  en: {
    ...
    hero: {
      ...
      description: "Crafting scalable web systems and process automation with clean architecture and strategic use of AI.",
      cta: "Get in touch",
      resume: "View GitHub"
    },
    about: {
      ...
      philosophyText: "Software development should solve real-life problems. Often we have difficulty seeing how technological innovation translates into the lives of non-technical people; and what I find most valuable is using technology to make their lives easier."
    },
    stack: {
      title: "Tech Stack",
      description: "Technologies I work with on a daily basis to build robust solutions."
    },
    projects: {
    ...
    contact: {
      title: "Get In Touch",
      description: "Available for remote opportunities, on-demand projects, and technical collaborations.",
      form: {
        name: "Name",
        email: "Email",
        message: "Message",
  ...
  pt: {
    ...
    hero: {
      ...
      description: "Criando sistemas web escaláveis e automação de processos com arquitetura limpa e uso estratégico de IA.",
    ...
    about: {
      ...
      philosophyText: "O desenvolvimento de software deve resolver problemas da vida real. Muitas vezes temos dificuldade em ver como a inovação tecnológica se traduz na vida de pessoas não técnicas; e o que acho mais valioso é usar a tecnologia para facilitar a vida delas."
    },
    stack: {
      title: "Tecnologias",
      description: "Ferramentas que utilizo diariamente para construir soluções robustas."
    },
    projects: {
    ...
    contact: {
      ...
      description: "Disponível para oportunidades remotas, projetos sob demanda e colaborações técnicas.",
      form: {
        name: "Nome",
        email: "E-mail",
        message: "Mensagem",
